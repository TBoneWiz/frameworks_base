...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private static final int MSG_DISPOSE_INPUT_CONSUMER = 16;
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(SlimSettings.System.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(SlimSettings.System.getUriFor(
                    SlimSettings.System.ACCELEROMETER_ROTATION_ANGLES), false, this,
                    UserHandle.USER_ALL);
            updateSettings();
        }
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mUserRotationAngles = SlimSettings.System.getIntForUser(resolver,
                    SlimSettings.System.ACCELEROMETER_ROTATION_ANGLES, -1,
                    UserHandle.USER_CURRENT);
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        ...
        if (keyCode == KeyEvent.KEYCODE_HOME) {
            ...
            if (!down) {
                ...
                if (unpinActivity(true) || mDoubleTapOnHomeBehavior != DOUBLE_TAP_HOME_NOTHING) {
